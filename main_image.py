...
def get_args_parser():
    ...
    parser.add_argument('--padapt_L_size', default=197, type=int, help='number of bottleneck of PA')
    ...
    parser.add_argument('--padapt_local', default='p_a_m', type=str, help='where to use PA', choices=['p_a_m', 'a_p_m', 'a_m_p', 'p+a_m', 'a_p+m', 'p+b'])
    ...
    # custom configs
    parser.add_argument('--drop_path', type=float, default=0.0, metavar='PCT', help='Drop path rate (default: 0.0)')
